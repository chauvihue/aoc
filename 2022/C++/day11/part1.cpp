...
{
    public:
        queue<int> starting_items;
        Operator opt;
        int opt_val, test_val, true_monkey, false_monkey, inspected_cnt = 0;

        int cal_worry_level()
        {
            int cur_worry_level = starting_items.front(), res;
            starting_items.pop();
            if (opt == PLUS)
...
{
    int new_worry_level = cal_worry_level(), des_monkey;
